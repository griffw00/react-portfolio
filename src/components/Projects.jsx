  ...
  const projectData = [
    {
      ...
      description:
        "Going to the gym is a significant part of my life, which inspired me to create JFitness, an application designed to help users track their gym schedules and progress. This project was my first personal project and taught me several key concepts, including Object-Oriented Programming (OOP), data persistence, and the implementation of a graphical user interface (GUI).",
    },
    {
      name: "Portfolio",
      technologies: "React",
    ...
    },
    {
      ...
      description:
        "My first dabble with mobile applications! Native ToDo is a simple CRUD application build using TypeScript and React Native. Through this mini-project, I was able to learn the fundamentals of TypeScript and learn how to create functional components for mobile applications.",
    },
    {
    ...
    },
    {
      ...
      description:
        "An API that was built using Java and Spring Boot. My API adheres to RESTful principles and allows users to perform CRUD operations via HTTP requests. This project was a great way to solidify my Java skills and served as my introduction to the Spring framework.",
    },
    {
    ...
    },
    {
      ...
      description:
        "This personal project stemmed from my love for gaming and a desire to find free games during my downtime. Using vanilla JavaScript, HTML, and CSS, I crafted a game recommender that fetches real-time data from Rapid API and parses it for display. It marked my introduction to pure HTML and CSS, alongside API calls. Through this project, I explored the fundamental of RESTful principles.",
    },
  ];
